...
function GetAllDataPage() {
  ...
  async function getAllDAta() {
    await axios
      .get("https://backend-api-college.onrender.com/api/v1/student")
      .then((response) => {
  ...
  async function getVerifiedData() {
    await axios
      .get("https://backend-api-college.onrender.com/api/v1/student/verified")
      .then((res) => {
  ...
  async function getUnVerifiedData() {
    await axios
      .get("https://backend-api-college.onrender.com/api/v1/student/Unverified")
      .then((res) => {

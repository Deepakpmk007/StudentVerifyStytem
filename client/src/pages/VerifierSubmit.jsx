...
function VerfierSubmit() {
  ...
  const handleVerificationUpdate = () => {
    axios
      .put(`https://backend-api-college.onrender.com/api/v1/student/verified/${id}`, {
        verified: true,
      })
      .then((response) => {
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          `https://backend-api-college.onrender.comapi/v1/student/${id}`
  ...
  const handleFileUpload = async function () {
    ...
    await axios
      .post("https://backend-api-college.onrender.com/api/v1/upload", formData, {
        headers: {
  ...
  async function emailSend() {
    await axios
      .post("https://backend-api-college.onrender.com/api/v1/finalEmail", {
